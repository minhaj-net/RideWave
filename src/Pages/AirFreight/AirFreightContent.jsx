...
const AirFreightContent = () => {
  ...
  const features = [
    "Air freight offers predictable schedules.",
        ...
        <div className="grid grid-cols-1  gap-12">
          ...
          <div className="lg:col-span-8 flex flex-col gap-8 order-1 lg:order-2">
            ...
            <div className="w-full h-[450px] rounded-[40px] overflow-hidden shadow-2xl">
              <img
                src="https://i.ibb.co.com/MxrgRY1X/air.jpg"
                alt="Air Freight"
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="space-y-6">
                <p className="text-gray-500 text-sm leading-relaxed">
                  Our Air Freight Services offer comprehensive solutions for all
                  your shipping needs, ensuring your cargo is transported
                  efficiently and safely across the globe, giving you peace of
                  mind and the best results for your business.With our Air
                  Freight Services, we handle all aspects of your air shipping
                  needs, documentation to delivery.
                </p>
                <p className="text-gray-500 text-sm leading-relaxed">
                  With our Air Freight Services, we handle all aspects of your
                  air shipping needs, from documentation to delivery, ensuring
            ...
            <div className="flex flex-col gap-6 py-6 border-y border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed">
                ...
                your shipping needs, ensuring your cargo is transported
                efficiently and safely across the globe, giving you peace of
                mind and the best results for your business.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="h-64 rounded-[30px] overflow-hidden shadow-lg transform transition-transform hover:scale-[1.02] duration-500">
                <img
                  src="https://i.ibb.co.com/k6xZq00H/serv-g1.jpg"
              ...
              <div className="h-64 rounded-[30px] overflow-hidden shadow-lg transform transition-transform hover:scale-[1.02] duration-500">
                <img
                  src="https://i.ibb.co.com/C5X1GJNF/serv-g2.jpg"
                  alt="Cargo Boxes"
                  className="w-full h-full object-cover"
                />
              </div>
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Our Air Freight Services offer comprehensive solutions for all
              your shipping needs, ensuring your cargo is transported
              efficiently and safely across the globe, giving you peace of mind
...
export default AirFreightContent;
